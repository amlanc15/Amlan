...
<html lang="en">
<head>
	<title>LIST OF SERVICE CENTER</title>
	<meta charset="UTF-8">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 p-b-30">
					...
					<header>
						<?php
$Query = mysql_query("SELECT * FROM servicecenter");
if(mysql_num_rows($Query)>0){
	echo "Records found: ".mysql_num_rows($Query);
?>
<table cellpadding="5" border="1" cellspacing="0">
<thead>
	<tr>
    	<th><font color="white">Sl No</font></th><th><font color="white">NAME</font></th><th><font color="white">ADDRESS</font></th>
		<th><font color="white">PHONE NO</font></th><th><font color="white">EMAIL</font></th><th><font color="white">UPDATE</font></th>
	</tr>
</thead>
<tbody>
<?php  
...
<form>
    ...
    <td><?php echo $sl?></td>
		...
		<td><a href="updatesupplier.php? id=<?php echo $row['id']?>">UPDATE</a></td>
        </tr>
        <?php $sl++; }?>
		<tr>
		<td><input type="button" value="Print" onClick="printDiv('print-content')"></td>
		</tr>
		</form>
		</div>
        <?php }
