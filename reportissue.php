			...
			<div class="row">
				<div class="col-lg-12 p-b-30">
					<div class="t-center">
						...
						MENTION THE ISSUE IN BRIEF
						</span>
						
						<form class="wrap-form-reservation size22 m-l-r-auto" method="post" action="issuescontroller.php">
						<div class="row">
							<div class="col-md-4">
								<!-- Date -->
								<div class="wrap-inputphone size12 bo2 bo-rad-10 m-t-3 m-b-23">
									<input class="bo-rad-10 sizefull txt10 p-l-20" type="textarea" name="comments" placeholder="PROBLEM">
								</div>
							</div>
