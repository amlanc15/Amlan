			...
			<div class="row">
				<div class="col-lg-12 p-b-30">
					<div class="t-center">
						...
						<?php $gn=$_SESSION['fb_session']['gname'];
							$Query = mysql_query("SELECT * FROM pctable p WHERE p.status='$gn'");
...
<thead>
	<tr>
    	<th>Warrenty</th><th>Supplier</th>
		<th>Status</th><th>Ram</th><th>Harddisk</th>
		<th>Processor</th><th>KeyBoard No</th><th>CPU No</th>
		<th>Monitor No</th><th>Mouse No</th><th>OS</th>
	</tr>
</thead>
<tbody>
<?php  
 ...
 while($row=mysql_fetch_array($Query)){ ?>
	...
	echo "<h2>YOUR PC IS NOT ALLOCATED TILL NOW</h2>";
