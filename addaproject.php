				...
				<div class="col-lg-12 p-b-30">
					<div class="t-center">
						...
						<h3 class="tit3 t-center m-b-35 m-t-2">
							<font color="white">ADD A PROJECT</font>
						</h3>
					</div>
<form class="wrap-form-reservation size22 m-l-r-auto" method="post" action="addaprojectcontroller.php">
						<div class="row">
							<div class="col-md-4">
								<!-- Date -->
								<span class="txt9">
								...
								<div class="wrap-inputphone size12 bo2 bo-rad-10 m-t-3 m-b-23">
									<input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="projectname" placeholder="PROJECT NAME">
								</div>
							</div>
							<div class="col-md-4">
								<!-- Date -->
								<span class="txt9">
								 <font color="red">PROJECT GUIDE NAME</font>
								</span>
								<div class="wrap-inputphone size12 bo2 bo-rad-10 m-t-3 m-b-23">
									<input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="projectguide" placeholder="PROJECT GUIDE">
								</div>
							</div>
