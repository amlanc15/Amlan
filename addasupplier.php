				...
				<div class="col-lg-12 p-b-30">
					<div class="t-center">
						...
						<h3 class="tit3 t-center m-b-35 m-t-2">
							<font color="white">ENTER THE DETAILS OF THE SUPPLIER</font>
						</h3>
					</div>
<form class="wrap-form-reservation size22 m-l-r-auto" method="post" action="supplierontroller.php">
						<div class="row">
							<div class="col-md-4">
								<!-- Date -->
								<span class="txt9">
									<font color="red">SUPPLIER NAME</font>
								</span>
