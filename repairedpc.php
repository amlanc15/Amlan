		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 p-b-30">
					...
					<header>
												<?php
$Query = mysql_query("SELECT * FROM damaged WHERE status='delivered'");
if(mysql_num_rows($Query)>0){
?>
<table cellpadding="5" border="1" cellspacing="0">
<thead>
	<tr>
    	<th>Sl No</th><th>PC NO</th><th>SUPPLIER NAME</th>
		</th><th>CPU NO</th><th>MONITOR NO</th><th>MOUSE NO</th>
		<th>KEYBOARD NO</th><th>DELIVRY DATE</th><th>PROBLEM</th>
		<th>COST</th>
	</tr>
</thead>
<tbody>
...
?>
        ...
        <td><?php echo $row['expdeliverydate']?></td>
        <td><?php echo $row['problem']?></td>
        <td>Rs/-<?php echo $row['charge']?> INR</td>
        </tr>
