...
<form class="wrap-form-reservation size22 m-l-r-auto" method="post" action="addpc.php">
						<div class="row">
							<div class="col-md-4">
								<!-- Date -->
								<span class="txt9">
							...
							<div class="col-md-4">
								...
								<div class="wrap-inputtime size12 bo2 bo-rad-10 m-t-3 m-b-23">
									<!-- Select2 -->
									<select class="selection-1"  name="group" id="group"><option value=""> SUPPLIER NAME </option>
										<?php
											$query = mysql_query("SELECT sname FROM supplier");
							...
							<div class="col-md-4">
								...
								<select class="selection-1" name="status" id="status">
							...
							<div class="col-md-4">
								...
								<div class="wrap-inputtime size12 bo2 bo-rad-10 m-t-3 m-b-23">
									<!-- Select2 -->
									<select class="selection-1"  name="harddisk" id="group"><option value=""> HARD DISK </option>
										<option value="2 GB">500 GB</option>
										<option value="4 GB">1 TB</option>
										<option value="8 GB">2 TB</option>
									</select>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-4">
								...
								<select class="selection-1"  name="os" id="os"><option value="">OPERATING SYSTEM</option>
                        ...
                        <option value="Linux">LINUX</option>
							...
							<div class="col-md-4">
								...
								<div class="wrap-inputphone size12 bo2 bo-rad-10 m-t-3 m-b-23">
									<input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="keybno" placeholder="KEYBOARD NO">
								</div>
							</div>
							...
							<div class="col-md-4">
								...
								<div class="wrap-inputemail size12 bo2 bo-rad-10 m-t-3 m-b-23">
									<input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="monitorno" placeholder="MONITOR NO">
								</div>
							</div>
							<div class="col-md-4">
								<!-- PASSOUT YEAR -->
								...
								<div class="wrap-inputphone size12 bo2 bo-rad-10 m-t-3 m-b-23">
									<input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="CPU NO" placeholder="CPU NO">
								</div>
							</div>
						<div class="col-md-4">
								<!-- PASSOUT YEAR -->
								...
								<div class="wrap-inputphone size12 bo2 bo-rad-10 m-t-3 m-b-23">
									<input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="mouseno" placeholder="MOUSE NO">
								</div>
							</div>
